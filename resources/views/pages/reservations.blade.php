            ...
            <div class="col-md-6">
                ...
                <form method="POST" action="/reservations">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputphonenumber" type="tel" class="form-control form-control-lg @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required
                        autocomplete="phone_number" autofocus placeholder="example: 3475789090">
