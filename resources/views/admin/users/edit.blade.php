                ...
                <div class="card-body">
                    <form method="POST" action="/admin/users/{{$user->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputfirstname" type="text" class="form-control form-control-lg @error('fname') is-invalid @enderror" name="fname" value="{{ old('fname', $user->fname) }}" required autocomplete="name"
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputlastname" type="text" class="form-control form-control-lg @error('lname') is-invalid @enderror" name="lname" value="{{ old('lname', $user->lname) }}" required autocomplete="name" autofocus
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputemail" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email', $user->email) }}" required autocomplete="email"
                            placeholder="Email">
